...
import linkk from '../Assets/linkedin.svg'
...
const Home = () => {
    ...
    return (
        <>
            ...
            <div><a href='https://www.linkedin.com/in/dhruv-sharma-ba7820271/'><img style={{ height: "20px",position:"fixed",bottom:15,right:15 }} src={linkk} alt="aha" /></a>
</div>
        </>
    )
}
